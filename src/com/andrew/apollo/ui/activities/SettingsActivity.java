...
import com.andrew.apollo.utils.customwidget.WidgetSkin;
...
public class SettingsActivity extends SherlockPreferenceActivity {
    ...
    private void openWidgetSkinChooser() {
        final Preference themeChooser = findPreference("widget_skinchooser");
    ...
    private void openThemeChooser() {
        final Preference s = findPreference("theme_chooser");
